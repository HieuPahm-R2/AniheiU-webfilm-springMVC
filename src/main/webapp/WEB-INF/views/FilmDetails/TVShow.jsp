...
<html>
  ...
  <body>
    ...
    <section class="section details">
      <!-- details background -->
      <div class="details__bg" data-bg="${film.thumbnail}"></div>
        ...
        <div class="row">
                ...
                <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-9">
                  <div class="card__content">
                    ...
                    <ul class="card__meta">
                      <li>
                        <span>Genre:</span>
                        <code:forEach items="${film.categories}" var="category">
                      ...
                      <li>
                        <span>Seasons:</span> ${film.seasons.size()} seasons
                      </li>
                      <li>
                        <span>Country:</span>
                        <a href="#">${film.country.name}</a>
                      </li>
                    </ul>
          ...
          <div class="col-12 col-xl-6">
            <iframe
              width="100%"
              height="100%"
              src="https://www.youtube.com/embed/jF-tPrcAimQ"
              title="【歌ってみた】祝福 / YOASOBI  【にじさんじフミ】"
              frameborder="0"
          ...
          <div class="col-12 col-xl-6">
            <div class="accordion" id="accordion">
              <c:forEach items="${film.seasons}" var="season">
                        ...
                        <tbody>
                          <c:forEach items="${season.episodes}" var="episode">
                            <tr>
                              <th>${episode.id}</th>
                              <td>
                                ${season.seasonName} Ep.${episode.episode}
                              </td>
    ...
    <%@include file="../decorator/footer/footer.jsp" %> <%@include
    file="../decorator/script/script.jsp" %>
  </body>
</html>
