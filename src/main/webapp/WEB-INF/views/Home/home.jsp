                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="owl-carousel home__carousel">
                                        <c:forEach items="${filmList}" var="x">
                                            <div class="item">
                                                <!-- card -->
                                                ...
                                                <div class="card card--list">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm-8">
                                                            <div class="card__content">
                                                                <h3 class="card__title"><a href="#">${x.name}</a>
                                                                </h3>
                                                                <span class="card__category">
                                                                    <c:forEach items="${x.categories}" var="category">
                                                                        <a
                                                                ...
                                                                <div class="card__wrap">
                                                                    <span class="card__rate"><i
                                                                            class="icon ion-ios-star"></i>6.3</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                                            <div class="card">
                                                ...
                                                <div class="card__content">
                                                    <h3 class="card__title"><a href="#">I Dream in Another Language</a>
                                                    </h3>
                                                    <span class="card__category">
                                                        <a href="#">Action</a>
                                                        <a href="#">Triler</a>
